  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-6 shadow-sm z-10 shrink-0">
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <button
          onClick={onMenuAc}
          className="lg:hidden p-2 text-slate-500 hover:bg-slate-100 rounded-md transition-colors shrink-0"
        ...
        {/* Arama Alanı */}
        <div className="flex items-center bg-slate-100 px-3 py-2 rounded-md flex-1 max-w-sm">
